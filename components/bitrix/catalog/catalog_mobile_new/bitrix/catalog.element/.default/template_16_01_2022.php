...
<div class="l-cols4" itemscope itemtype="http://schema.org/Product">
	...
	<div class="l-col1 js-tab-group">
			...
			if(count($arResult['OFFERS']) <= 1){
				if((count($arResult['OFFERS']) == 1) || ($arResult['CATALOG_TYPE'] == CCatalogProduct::TYPE_SET) ){?>
					...
					<div class="prod__price">
						...
						<?}?>
						<div class="prod__sum">
							<?if($arResult['OFFERS'][0]['PRICES'][$_SESSION['region_price']]['PRINT_DISCOUNT_VALUE']) echo $arResult['OFFERS'][0]['PRICES'][$_SESSION['region_price']]['PRINT_DISCOUNT_VALUE'];
							 else echo $arResult['MIN_PRICE']['PRINT_DISCOUNT_VALUE'];?>
						</div>
						<?
						...
						</span><?if($arResult['OFFERS'][0]['ID']) $ITEM_ID = $arResult['OFFERS'][0]['ID']; else $ITEM_ID = $arResult['ID'];?>
						...
						<!--<div><a class="buy-click js-popup-link" href="js-popup-buy" data-id="<?=$arResult['OFFERS'][0]['ID']?>">Быстро купить в 1 клик</a></div>-->
						  ...
						  <div><a class="buy-click js-popup-link2" href="js-popup-buy" data-id="<?=$ITEM_ID?>">Быстро купить в 1 клик</a></div>  
		...
		<ul class="tab-simple js-tab">
			...
			<li>
				<a href="js-tab4"><span>Видео <?if(count($arResult['PROPERTIES']['VIDEO']['~VALUE']) and is_array($arResult['PROPERTIES']['VIDEO']['VALUE'])){echo "(".count($arResult['PROPERTIES']['VIDEO']['~VALUE']).")";}?></span></a>
			</li>
		</ul>
